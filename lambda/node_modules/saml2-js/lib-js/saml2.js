...
check_saml_signature = function(xml, certificate, cb) {
  ...
  console.log('in check_saml_signature, certificate: %j', certificate);
...
parse_authn_response = function(saml_response, sp_private_key, idp_certificates, allow_unencrypted, cb) {
  ...
  user = {};
  console.log('in parse_auth_response, idp_certificates: %j', idp_certificates);
...
module.exports.ServiceProvider = ServiceProvider = (function() {
  ...
  ServiceProvider.prototype._assert = function(identity_provider, options, cb) {
    ...
    console.log('in ServiceProvider.prototype._assert, identity_provider: %j', identity_provider);
